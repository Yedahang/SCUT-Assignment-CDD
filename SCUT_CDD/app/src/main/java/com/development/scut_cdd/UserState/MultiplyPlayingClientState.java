...
public class MultiplyPlayingClientState implements UserState{
    public MultiplyPlayingClientState(String ip) {
        CardBoardActivity.getCardBoardActivity().initClient(ip);
        ...
        CardBoardActivity.getCardBoardActivity().getUiCon().setJustIntoRoom(true);
